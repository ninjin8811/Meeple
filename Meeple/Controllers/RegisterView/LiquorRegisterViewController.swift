//
//  LiquorRegisterViewController.swift
//  Meeple
//
...
class LiquorRegisterViewController: UIViewController {

    @IBOutlet weak var tableview: UITableView!
    @IBOutlet weak var nextButton: UIButton!
    
    let liquorList = UserSelectData.liquorList()
    ...
    override func viewDidLoad() {
        ...
        prepareDesign()
        //テーブルビューの設定
        tableview.register(UINib(nibName: "RegisterTableViewCell", bundle: nil), forCellReuseIdentifier: "liquorCell")
...
extension LiquorRegisterViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return liquorList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "liquorCell") as? RegisterTableViewCell {
            cell.titleLabel.text = liquorList[indexPath.row]
