...
class GenderRegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        prepareDesign()
        //テーブルビューの設定
        tableview.register(UINib(nibName: "RegisterTableViewCell", bundle: nil), forCellReuseIdentifier: "registerCustomCell")
...
extension GenderRegisterViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "registerCustomCell") as? RegisterTableViewCell {
